...
public class PostAggregate : AggregateRoot
{
    ...
    public void EditComment(Guid commentId, string comment, string username)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to edit an comment that was made by another user!");
        }
    ...
    public void RemoveComment(Guid commentId, string username)
    {
        ...
        if (!_comments[commentId].Item2.Equals(username, StringComparison.CurrentCultureIgnoreCase))
        {
            throw new InvalidOperationException("You are not allowed to remove an comment that was made by another user!");
        }
    ...
    public void DeletePost(string username)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannot delete a comment to an inactive post!");
        }

        if (!_author.Equals(username, StringComparison.CurrentCultureIgnoreCase))
        {
            throw new InvalidOperationException("You are not allowed to delete an comment that was made by another user!");
        }
